...
export function HeroSection() {
  ...
  const planetOpacity = useTransform(scrollYProgress, [0, 0.4], [0.9, 0.25]);
  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden bg-[#020617] px-6 pt-24">
      ...
      <motion.div
        ...
        className="absolute -bottom-52 left-1/2 h-[520px] w-[520px] -translate-x-1/2 rounded-full bg-gradient-to-br from-blue-400 via-emerald-400 to-blue-900 shadow-[0_0_140px_rgba(96,165,250,0.5)] md:-bottom-64 md:h-[760px] md:w-[760px]"
      >
        <div className="absolute inset-10 rounded-full bg-[radial-gradient(circle_at_30%_30%,#ffffff99,transparent_18%),radial-gradient(circle_at_65%_45%,#22c55e99,transparent_20%),radial-gradient(circle_at_45%_70%,#2563ebaa,transparent_24%)] opacity-70" />
